                                ...
                                <div class="col-sm-5 ">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-4">
                                            <input required pattern="^d{3}$" type="name" />
                                        </div>
                                        <div style="padding:0;"class="col-sm-4 col-xs-4">
                                            <input required pattern="^d{2}$" type="name" />
                                        </div>
                                        <div class="col-sm-4 col-xs-4">
                                            <input required pattern="^d{4}$" type="name"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-7 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <input id="dateOfBirthPicker" type="name"/>
                                        </div>
                                    </div>
                                </div>
