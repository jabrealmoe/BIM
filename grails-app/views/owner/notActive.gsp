      ...
      <div class="spag_content">
        <div class="row">
          <div class="col-sm-9 col-xs-12">
            ...
            <div class="field">
              <div class="row ">
                <div style="margin-top: 30px;margin-bottom: -10px" class="alert-warning alert form-group col-sm-offset-1 col-sm-10 col-sm-offset-1 col-xs-12">
                  <span style=" color:darkblue;padding-top: -1%"><g:message code="default.amtcs.member.number.notactive" /></span>
